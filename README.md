...
| Repository | What it is |
|------------|------------|
| [**tuning-math**](https://github.com/svdesilva/tuning-math) | **Cents and ratios** — ET vs just vs a Pythagorean-ish fifth column. ![CI](https://github.com/svdesilva/tuning-math/actions/workflows/ci.yml/badge.svg?branch=main) |
